 ...
 */
public class JFrameNewFactorBase extends javax.swing.JFrame {

    FactorCollection factors;
    protected EventListenerList listeners = new EventListenerList();
    
    /**
     * Creates new form JFrameNewFactorBase
     */
    public JFrameNewFactorBase() {
        initComponents();
    }

    public JFrameNewFactorBase( FactorCollection factors ) {
        initComponents();
...
/*
  public void addFactorEventListener( FactorEventListener listener) {
    listeners.add(FactorEventListener.class, listener);
  }
  public void removeFactorEventListener(FactorEventListener listener) {
    listeners.remove(FactorEventListener.class, listener);
  }    
  */  
    /**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameNewFactorBase.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameNewFactorBase().setVisible(true);
            }
        });
    }
